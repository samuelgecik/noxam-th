...
export async function generateMetadata({
	...
	return {
		...
		alternates: {
			languages: { en: "/en/contact", th: "/th/contact" },
		},
	};
}
					...
					<div className="grid lg:grid-cols-12 gap-12">
						...
						<div className="lg:col-span-5 flex flex-col gap-6">
							...
							<div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
								...
								<div className="space-y-4">
									<div className="flex items-start gap-3">
										...
										<div>
											<h4 className="font-bold text-gray-900 text-sm">{t("office_address_label")}</h4>
											<p className="text-gray-600 text-sm whitespace-pre-line">{t("office_address")}</p>
										</div>
									</div>
									<div className="flex items-start gap-3">
										<div className="p-2 bg-white rounded-lg shadow-sm text-primary">
										...
										<div>
											<h4 className="font-bold text-gray-900 text-sm">{t("office_phone_label")}</h4>
											<p className="text-gray-600 text-sm">{t("office_phone")}</p>
										</div>
									</div>
									<div className="flex items-start gap-3">
										<div className="p-2 bg-white rounded-lg shadow-sm text-primary">
										...
										<div>
											<h4 className="font-bold text-gray-900 text-sm">{t("office_email_label")}</h4>
											<p className="text-gray-600 text-sm">{t("office_email")}</p>
										</div>
									</div>
									<div className="flex items-start gap-3">
										<div className="p-2 bg-white rounded-lg shadow-sm text-primary">
										...
										<div>
											<h4 className="font-bold text-gray-900 text-sm">{t("office_hours_label")}</h4>
											<p className="text-gray-600 text-sm whitespace-pre-line">{t("office_hours")}</p>
										</div>
									</div>
								</div>
							</div>
							...
							<div className="bg-gray-50 rounded-2xl p-6 border border-gray-100">
								...
								<div className="space-y-3">
									...
									>
										...
										<div>
											<p className="font-bold text-[#25D366] text-sm">{t("chat_whatsapp")}</p>
											<p className="text-xs text-gray-600">{t("chat_whatsapp_desc")}</p>
										</div>
									...
									>
										...
										<div>
											<p className="font-bold text-[#00B900] text-sm">{t("chat_line")}</p>
											<p className="text-xs text-gray-600">{t("chat_line_desc")}</p>
										</div>
							...
							<div className="bg-primary rounded-2xl p-6 text-white">
								<h3 className="text-xl font-bold mb-4">{t("urgent_title")}</h3>
								<p className="text-blue-100 text-sm mb-4">
									{t("urgent_description")}
								</p>
								<a
